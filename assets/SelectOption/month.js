function loadSelectOption(id, inputId, itemsId, selectId, items) {
  ...
  document.getElementById(id).innerHTML = `<div class="wrapper-select-option">
        <div class="form-input-option" >
            <input id="${inputId}" class="input-option" type="text" placeholder="Month" readonly />
...
function loadSelectOptions(id, inputId, itemsId, selectId, items) {
  const listItemsOption = items
    .map((element) => {
      let result = "";
      result += `<div class="items-option ${selectId}">${element}</div>`;
  ...
  document.getElementById(id).innerHTML = `<div class="wrapper-select-option">
        <div class="form-input-option" >
            <input id="${inputId}" class="input-option" type="text" placeholder="Date" readonly />
            <img class="ic-down-select" src="../../images/public/ic-down-select.svg" />
        </div>
        <div id="${itemsId}" class="list-items-option" >
            ${listItemsOption}
...
function loadSelectOptionss(id, inputId, itemsId, selectId, items) {
  const listItemsOption = items
    .map((element) => {
      let result = "";
      result += `<div class="items-option ${selectId}">${element}</div>`;
  ...
  document.getElementById(id).innerHTML = `<div class="wrapper-select-option">
        <div class="form-input-option" >
            <input id="${inputId}" class="input-option" type="text" placeholder="Choose" readonly />
            <img class="ic-down-select" src="../../images/public/ic-down-select.svg" />
        </div>
        <div id="${itemsId}" class="list-items-option" >
            ${listItemsOption}
